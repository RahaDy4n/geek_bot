...
/////////////////
const BotName = 'Geek-bot'; 
const instagram = 'https://instagram.com/gem_in_anime?igshid=151f9urq0p9y3'; 
const telegram = 'Ga punya'; 
const kapanbotaktif = '10 pagi sampai 10 malam'; 
const youtube = 'https://youtube.com/channel/UCQAW4PmtbEWI7Z1Ql-Am_Mw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@gem_in_anime)
...
//AKHIRNYAAAAAAAA CPEK GW ANJING
