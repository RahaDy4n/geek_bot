...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'FN:RahaDyan\n' // NAMA OWNER BOT
            + 'ORG:Creator RahaDyan BOT;\n' // KASIH CREDITS GUA FADHIL GRAPHY SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6285849622774:+62 858-4962-2774\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6285849622774@s.whatsapp.net', options, text, {quoted: mek})
